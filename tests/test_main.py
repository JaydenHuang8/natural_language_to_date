...
def test_days_after_a_date():
    assert parse("5 days after December 1st, 2025", today = date(2025, 12, 1)) == date(2025, 12, 6)

def test_days_before_a_date():
    assert parse("5 days before December 1st, 2025", today = date(2025, 12, 1)) == date(2025, 11, 26)
